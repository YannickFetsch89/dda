"""
spontacts.py – DiesDasDüsseldorf
Playwright-Scraper für Spontacts Düsseldorf.

Scrapt Freizeitaktivitäten und Community-Events von Spontacts für Düsseldorf.
Spontacts ist eine Plattform für spontane Aktivitäten, Sport und Community-Treffen.

Strategie:
1. Primär: JSON-LD structured data (schema.org/Event)
2. Fallback: HTML-Parsing der Veranstaltungsliste

URL: https://www.spontacts.com/p/duesseldorf
Erstellt: 2026-03-06
"""
import asyncio
import json
...
LISTE_URL = "https://www.spontacts.com/p/duesseldorf"
BASE_URL = "https://www.spontacts.com"
QUELLE_NAME = "Spontacts Düsseldorf"
...
# Kategorie-Mapping für Spontacts-Events
KATEGORIE_MAPPING = {
    "wandern": "outdoor", "spazier": "outdoor", "natur": "outdoor", "park": "outdoor",
    "outdoor": "outdoor", "strand": "outdoor", "radfahren": "outdoor", "fahrrad": "outdoor",
    "joggen": "sport", "laufen": "sport", "sport": "sport", "fitness": "sport",
    "volleyball": "sport", "fußball": "sport", "tennis": "sport", "klettern": "sport",
    "schwimmen": "sport", "tanzen": "sport", "yoga": "sport",
    "konzert": "musik", "musik": "musik", "live": "musik",
    "party": "nightlife", "club": "nightlife", "nacht": "nightlife",
    "workshop": "community", "meetup": "community", "networking": "community",
    "stammtisch": "community", "treffen": "community", "gruppe": "community",
    "kinder": "family", "familie": "family",
    "essen": "food", "food": "food", "restaurant": "food", "kochen": "food",
    "kunst": "kultur", "kultur": "kultur", "museum": "kultur", "ausstellung": "kultur",
    "dating": "dating", "singles": "dating", "flirt": "dating",
}
    ...
    for script in soup.find_all("script", type="application/ld+json"):
        ...
        for eintrag in eintraege:
            if not isinstance(eintrag, dict):
                continue
            if eintrag.get("@type") not in ("Event", "SocialEvent", "SportsEvent", "MeetupEvent"):
                continue
            ...
            # Ort aus structured data extrahieren
            ort_daten = eintrag.get("location")
            ort = ORT_STANDARD
            adresse = ADRESSE_STANDARD
            if isinstance(ort_daten, dict):
                ort = ort_daten.get("name") or ORT_STANDARD
                adresse_obj = ort_daten.get("address")
                ...
                elif isinstance(adresse_obj, str):
                    adresse = adresse_obj
...
def _events_aus_html(html: str, heute: date, enddatum: date) -> list[dict]:
    ...
    selektoren = [
        ".activity-card", ".activity-item", ".event-card", ".event-item",
        "article.activity", "div.activity", "li.activity",
        "article[class*='activity']", "div[class*='activity']",
        "article[class*='event']", "div[class*='event']",
        ".listing-item", ".post", "article",
    ]
...
async def scrape() -> list[dict]:
    """
    Scrapt Freizeitaktivitäten und Community-Events von Spontacts Düsseldorf.
