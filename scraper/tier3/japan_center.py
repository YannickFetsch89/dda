"""
japan_center.py – DiesDasDüsseldorf
Playwright-Scraper für das Japan Center Düsseldorf.

Scrapt japanische Kulturveranstaltungen und Events vom Japan Center Düsseldorf,
dem kulturellen Mittelpunkt der japanischen Gemeinschaft in der Landeshauptstadt.

Strategie:
1. Primär: JSON-LD structured data (schema.org/Event)
2. Fallback: HTML-Parsing der Veranstaltungsliste

URL: https://www.japan-duesseldorf.de/veranstaltungen
...
LISTE_URL = "https://www.japan-duesseldorf.de/veranstaltungen"
BASE_URL = "https://www.japan-duesseldorf.de"
QUELLE_NAME = "Japan Center Düsseldorf"
ORT_STANDARD = "Japan Center Düsseldorf"
ADRESSE_STANDARD = "Breite Str. 27, 40213 Düsseldorf"
KATEGORIE = "kultur"
...
# Kategorie-Mapping für japanische Kulturveranstaltungen
KATEGORIE_MAPPING = {
    "konzert": "musik", "musik": "musik", "live": "musik",
    "party": "nightlife", "club": "nightlife",
    "festival": "musik",
    "ausstellung": "kultur", "kunst": "kultur", "kultur": "kultur",
    "film": "kultur", "kino": "kultur",
    "workshop": "community", "vortrag": "community",
    "kinder": "family", "familie": "family",
    "essen": "food", "food": "food", "sushi": "food", "kochen": "food",
}


def _kategorie_erkennen(text: str) -> str:
    """
    Erkennt die passende Kategorie anhand des Titels oder Beschreibung.
    ...
    for script in soup.find_all("script", type="application/ld+json"):
        ...
        for eintrag in eintraege:
            if not isinstance(eintrag, dict):
                continue
            if eintrag.get("@type") not in ("Event", "ExhibitionEvent", "CulturalEvent", "VisualArtsEvent"):
                continue
...
async def scrape() -> list[dict]:
    """
    Scrapt Kulturveranstaltungen des Japan Centers Düsseldorf.
