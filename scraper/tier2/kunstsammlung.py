"""
kunstsammlung.py – DiesDasDüsseldorf
Scraper für die Kunstsammlung NRW (K20 & K21) Düsseldorf.

Beide Häuser werden über dieselbe Programm-Seite abgedeckt.
...
URL: https://www.kunstsammlung.de/de/programm
Erstellt: 2026-03-05
"""
import json
import logging
...
BASE_URL = "https://www.kunstsammlung.de"
PROGRAMM_URL = "https://www.kunstsammlung.de/de/programm"
QUELLE_NAME = "Kunstsammlung NRW (K20/K21)"
ORT_STANDARD = "Kunstsammlung NRW"
KATEGORIE_STANDARD = "kultur"

# Bekannte Ortsnamen für K20 und K21 zuordnen
ORT_MAP = {
    "k20": "K20 Grabbeplatz, Düsseldorf",
    "grabbeplatz": "K20 Grabbeplatz, Düsseldorf",
    "k21": "K21 Ständehaus, Düsseldorf",
    "ständehaus": "K21 Ständehaus, Düsseldorf",
    "standehaus": "K21 Ständehaus, Düsseldorf",
}
...
def _ort_erkennen(text: str) -> str:
    """
    Ordnet Ortsangaben K20 oder K21 zu.
    ...
    for script in soup.find_all("script", type="application/ld+json"):
        ...
        for eintrag in eintraege:
            ...
            if isinstance(ort_roh, dict):
                ...
                adresse_obj = ort_roh.get("address", {})
                if isinstance(adresse_obj, dict):
                    teile = [adresse_obj.get("streetAddress"), adresse_obj.get("postalCode"), adresse_obj.get("addressLocality")]
...
def _events_aus_next_data(soup: BeautifulSoup, heute: date) -> list[dict]:
    """
    Fallback: __NEXT_DATA__ JSON aus Next.js-App extrahieren.
...
def scrape() -> list[dict]:
    """
    Scrapt Veranstaltungen der Kunstsammlung NRW (K20 & K21).
